...
cabecalhoOutput = ["validade","operador","tipo_pessoa","tipo_uso","fabricante","modelo","numero_serie","peso_maximo_decolagem","cidade","estado","ramo"]
...
with open(outputFile, 'w',newline='', encoding='utf-8') as csvfile:
    ...
    for raw in jsonData:
        ...
        rows.append([raw["DataValidade"], dictOperador[raw["Operador"]], "PJ" if raw["CPFCNPJ"].find("/") != -1 else "PF", raw["TipoUso"], raw["Fabricante"], raw["Modelo"], raw["Numerodeserie"], raw["Pesomaximodedecolagem"], raw["CidadeEstado"][:-3], raw["CidadeEstado"][-2:], raw["Ramodeatividade"] if raw["Ramodeatividade"] != None else "Não Informado"])
